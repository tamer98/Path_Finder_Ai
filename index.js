...
import DataPrompt from "/Users/TamerAltaji/Desktop/Web Development Projects 2023/finalProject/db.js";
...
const openai = new OpenAI({
  apiKey: process.env.OPENAI_API  // api key the wroted one not the correct
});
...
function saveDataInDb(data){
  ...
  const newDataRes = new DataPrompt(data);
  newDataRes.save();
